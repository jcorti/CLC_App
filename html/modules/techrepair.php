...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tech Repairs</li>
...
<br><br>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                       ...
                       <br />
                      <select class='selectjs' name='sUserName' id='sUserName'  onchange="ddSelect();"  required>      
                                    ...
                                    <?php  
                                      ...
                                      foreach ($answer as $key => $value) { 
                                        echo"<option value='".$value['letter']."'>".$value['emails']."</option>";
 ...
 ?>
            ...
            <div class="box-footer">
              <button type="submit"name="submit" class="btn btn-primary pull-right" >Submit email</button>
</div>
            </div>  
        </div>  
