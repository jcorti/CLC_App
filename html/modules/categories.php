    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <button class="btn btn-primary" data-toggle="modal" data-target="#addCategories">Add Prefixs</button>
            ...
            <tbody>
              <?php
                ...
                foreach ($categories as $key => $value) {
                  ...
                  echo '<tr>
                          <td>'.($key+1).'</td>
                          <td class="text-uppercase">'.$value['prefix'].'</td>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="newPrefix" placeholder="Add Prefix" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-th"></i></span>
                <input class="form-control input-lg" type="text" name="newModel" placeholder="Add Model" required>
              </div>
            </div>
