 ...
 ?>
                    ...
                    <div class="form-group">
                      <div class="input-group"> 
                        ...
                        <select class="form-control" name="selectSchool" id="selectSchool" onchange="ddSchoolSelect();"  required>      
                   ...
                   <!--=====================================
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <label>Please enter the old serial</label>
                            ...
                            <tr>
                              ...
                              <td style="width: 50%">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="selectjs" name="newSerial" id="newSerial" onchange="ddSelect();" required>      
